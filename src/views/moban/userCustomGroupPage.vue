                ...
                <el-tabs v-model="activeName" type="card" @tab-click="tabsHandleClick">
                    <el-tab-pane label="主页tab1：复杂页面" name="second">
                        <div class="userCustomMobanPageContainer-buttons">
                            ...
                            <el-button @click="viewOnExportEvent">导 出</el-button>
                            <el-button @click="viewOnDelectEvent">删 除</el-button>
                            <el-button @click="viewOnShowEvent">查 看</el-button>
                            <el-button @click="viewOnTestEvent">测 试</el-button>
                            <el-button @click="viewOnAffirmEvent">确 认</el-button>
                            <el-button @click="viewOnCancelEvent">取 消</el-button>
                            <el-button @click="viewOnHelpEvent">帮 助</el-button>
                            <el-button @click="viewOnEditEvent">编 辑</el-button>
                            <el-button @click="viewOnAddedEvent">新 增</el-button>
                            <el-button @click="viewOnLastStepEvent">上一步</el-button>
                            <el-button @click="viewOnNextStepEvent">下一步</el-button>
                            <el-button @click="viewOnFullScreenEvent">全 屏</el-button>
                            <el-button @click="viewOnCancelFullScreenEvent">取消全屏</el-button>
                            <el-button @click="viewOnScreenshotsEvent">截 图</el-button>
                            <el-button @click="viewGetFileByPDFEvent">生成PDF</el-button>
                            <el-button v-print="'#viewOnPrintEvent'">打 印</el-button>
                            <el-button @click="viewOnSwitchEvent">切 换</el-button>
                            <el-button @click="viewOnTipsEvent">提 示</el-button>
                            <el-button @click="viewOnExitEvent">退 出</el-button>
                            <el-button @click="viewOnSelectPersonsEvent">选择人员</el-button>
                            <el-button @click="viewOnSendMessagesEvent">发 送</el-button>
                            <el-button @click="viewOnLockScreenEvent">锁 屏</el-button>
                            <el-button @click="viewOnSaveEvent">保 存</el-button>
                            <el-button @click="viewOnCopyEvent">复 制</el-button>
                            <el-button @click="viewOnClickObjectEvent">单 击</el-button>
                            <el-button @click="viewOnDblclickObjectEvent">双 击</el-button>
                        </div>
