<template>
  <div class="userCustomDialogPage1">
    <div class="userCustomDialogPageContainer">
        ...
        <div class="userCustomMobanPageContainer-msgDialog">
            <el-dialog title="弹窗模板1" :visible.sync="userCustomOfDialog" width="60%" :before-close="handleCloseDialog">
                ...
                <div class="userCustomMobanPageContainer-msgDialog__body">
                    <div class="userCustomMobanPageContainer-msgDialog__bodyTitle">弹窗模板1</div>
                        ...
                        <el-form label-width="40%" :inline="true" :model="conditionsForm" class="demo-form-inline userCustomMobanPageContainer-conditions__form">
                            <el-row>
                                ...
                                <el-col :span="24">
                                    ...
                                    <HyhtTextArea :modelHyhtTextAreaVal='modelHyhtTextAreaVal'></HyhtTextArea>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
...
export default {
    name: "userCustomDialogPage1",
    components:{
        HyhtInput,HyhtSelect,HyhtMupSelect,HyhtCascader,HyhtTextArea
    },
    data() {
        return {
            ...
            // 文本域
            modelHyhtTextAreaVal:{ modelValue:"121"},
        };
    },
    created() {
        var that = this;
    ...
    methods: {
        ...
        viewOnAffirmEvent(){
            ...
            var conditionsForm = {
                ...
                textAreaVal:that.modelHyhtTextAreaVal, //文本域
            }
